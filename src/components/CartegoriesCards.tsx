      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full">
        {Array.isArray(categoriesData) &&
          ...
          categoriesData.map((category) => {
            return (
              <li className="flex flex-col items-start justify-start transition-transform ease-out duration-700 hover:-translate-y-1 shadow border p-3 backdrop-blur-lg rounded bg-gradient-to-tl from-neutral-100 to-zinc-100 dark:border-slate-500 dark:from-neutral-800 dark:to-zinc-800">
