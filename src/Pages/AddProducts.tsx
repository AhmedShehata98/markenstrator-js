...
const AddProducts = () => {
  ...
  return (
    ...
    >
      ...
      <form className="content-container flex-wrap flex-row">
        <article className="flex flex-col min-h-screen w-full lg:w-[70%] px-4 py-2  bg-white dark:bg-zinc-800">
        ...
        <article className="flex flex-col gap-2 min-h-screen w-full lg:w-[30%] p-2  bg-white dark:bg-zinc-900">
